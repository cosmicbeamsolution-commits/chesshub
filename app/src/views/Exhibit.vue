<template>
  <div class="container max-height" :class="{ 'full-screen': toggleFullscreen}">
    <div class="content" v-show="time.level < 0">
      <div class="columns-centered fadeIn">
        <div class="columns is-flex flex-column gap-2 has-text-centered">
          <div class="">
            <h3>{{ 'exhibit' | t }}</h3>
            <!--div class="control">
    ...
    <div class="content expand" v-show="time.level > -1">
      <div class="columns is-gapless expand gap-2 fadeIn" :class="boardColor">
        <div class="column">
          ...
          <div class="container board-assistant">
            <div class="columns is-mobile has-text-centered w-100">
              ...
              <div class="black column is-paddingless">
                ...
                <span class="has-text-weight-bold">{{ opponentName }}</span>
                <span class="button is-small thinking" :class="{'is-loading' : isEngineRunning || thinking }"></span>
              </div>
            </div>
            ...
            <div class="columns has-text-centered">
              <div class="column">
                <div class="select is-fullwidth">
                  <select v-model="moveSeconds" id="piezas" title="Seconds">
            ...
            <div class="columns is-hidden-mobile w-100">
...
<div class="content">
  <div class="columns columns-bottom is-flex has-text-centered">
    ...
    drawChartPosition (draw) {
      if (!document.querySelector('.chart-indicator')) return
    ...
    gameStart (level) {
      ...
      setTimeout(() => {
        ...
        t.boardCfg.moveSpeed = this.player.moveSpeed || 500
        if (pref.pieces) {
    ...
    showHint () {
      ...
      setTimeout(() => { this.thinking = false }, 500)
      this.uciCmd('position startpos moves' + this.moveList())
      // this.uciCmd('eval', this.engine)
      this.uciCmd('go ' + (this.time.depth ? 'depth ' + this.time.depth : ''))
    },
