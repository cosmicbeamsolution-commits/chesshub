<template>
  <div class="container" :class="boardColor">
    <div class="container is-widescreen">
      <div class="content expand">
        <div class="columns expand gap-2">
          ...
          <div class="column">
            <div class="container board-assistant" v-if="Object.keys(data).length">
  ...
  methods: {
    ...
    gameMove () {
      if (!this.paused) {
        ...
        setTimeout(this.gameMove, this.moveSeconds * 1000)
      }
    },
    setMovesTable () {
  ...
  <div class="columns columns-bottom is-flex has-text-centered">
    ...
    gamePos (pos) {
      ...
      if (moved) {
        ...
        this.setMovesTable()
        this.drawChartPosition()
        var speed = this.player.moveSpeed || 500
        setTimeout(() => {
          this.moveSound(moved)
          this.addHightlight(moved)
        }, speed)
