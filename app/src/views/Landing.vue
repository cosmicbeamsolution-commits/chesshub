<template>
  <div class="container is-widescreen landing">
    <div class="area has-text-centered">
      <div class="columns is-vcentered has-padding-bottom z-index-1 fadeIn">
        <div class="column is-12 has-text-centered parent-translucid">
          <div class="has-text-centered has-padding-bottom">
            ...
            <div class="content columns is-flex gap-1 has-text-centered">
            ...
            <div class="columns is-flex-centered has-text-centered has-text-aligned animated fadeIn delay">
              <h5 class="has-text-centered">{{ 'play_against' | t }}</h5>
            </div>
            <div class="columns is-vcentered has-text-centered has-text-aligned">
              <div class="column">
                <a @click="$root.play" class="button is-medium is-success">
                  <!--span class="icon">
              ...
              <div class="column">
                <router-link class="button is-medium is-info" to="/stockfish">
                  <!--span class="icon">
            ...
            <div class="columns is-vcentered has-text-centered has-text-aligned">
              <div class="column">
                <router-link class="button is-medium is-info" to="/exhibit">
                  <!--span class="icon">
                    <span class="fa fa-server is-size-5"></span>
                  </span-->
                  <span>Stockfish</span>
